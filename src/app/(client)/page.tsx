    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <Slider className="w-full aspect-[16/9] md:aspect-[21/9]" autoplay={true} autoplayInterval={5000}>
            {heroSlides.map((slide, index) => (
              <Slide key={index} className="h-full  aspect-[16/9] md:aspect-[21/9]">
                <div className="relative w-full h-full rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4 text-white">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight max-w-4xl">
                      {slide.title}
                    </h1>
